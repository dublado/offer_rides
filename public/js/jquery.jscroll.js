...
(function($) {
    ...
    var jScroll = function($e, options) {
        ...
        if (_options.autoTrigger) {
            _nextWrap(_$next);
             if ($("body").height() <= $(window).height()) {
                ...
                _$scroll[0].ontouchend = function() { return _observe(); };
            }
        } else {
        ...
        function _observe() {
            _wrapInnerContent();
            var $inner = $e.find('div.jscroll-inner').last(),
                data = $e.data('jscroll'),
            ...
            if (_checkNextHref(data) && !data.waiting && (iTotalHeight + _options.padding + 30) >= $inner.outerHeight()) {
